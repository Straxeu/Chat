...
local onTimer       = {}
Config.WebHook = "https://discord.com/api/webhooks/1051494763410501653/eJ8-SC57EJsan68HRvbaLuju85zPA7ulljkC8wUNEPH_z9SEKYqFHrauS10G-ONm1aci" -- Discord Webhook
Config.Name = "MBRP.CZ" -- Jméno Serveru
Config.SteamApiKey = "" -- Steam WEBApiKey
Config.DiscordImage = "https://media.discordapp.net/attachments/1028734610990977125/1052567445027684352/MBRP.gif" -- Discord Fotka
...
local function AutoAnnouncer()
	SetTimeout(Config.AnnounceMinutes*60*1000, function()
		...
		TriggerClientEvent('chat:addMessage', -1, {
			template = '<div style="padding: 0.5vw; margin: 0.5vw; background-color: rgba(0, 0, 0, 0.79); border-radius: 10px; border: 1px solid rgba(0, 0, 0, 0.79); border-right: 5px solid rgba(187, 255, 0); box-shadow: inset 0 0 0.5em 0 rgba(0, 0, 0, 0.79), 0 0 0.5em 0 rgba(0, 0, 0, 0.79);"><i class="fas fa-align-justify"></i> MBRP POMOCNÍK <br> {0}</div>',
